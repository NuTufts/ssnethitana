...
export PATH=/cluster/kappa/90-days-archive/wongjiradlab/twongj01/ssnetana:${PATH}
export LD_LIBRARY_PATH=/cluster/kappa/90-days-archive/wongjiradlab/twongj01/ssnetana:${LD_LIBRARY_PATH}
...
run_ssnet_ana $supera $mcinfo ssnetout_larcv.root >& $logfile || exit

outfile=`printf ${output_dir}/ssnetana_%06d.root ${jobid}`
